...
type WaveletClient interface {
	...
	GetBlock(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResponse, error)
}
...
func (c *waveletClient) GetBlock(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResponse, error) {
	out := new(QueryResponse)
...
type WaveletServer interface {
	...
	GetBlock(context.Context, *QueryRequest) (*QueryResponse, error)
}
...
func _Wavelet_GetBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WaveletServer).GetBlock(ctx, req.(*QueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorRpc = []byte{
	...
	,
}
