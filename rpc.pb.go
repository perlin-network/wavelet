...
func (*GetBlockRequest) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{12} }
...
func (*GetBlockResponse) Descriptor() ([]byte, []int) { return fileDescriptorRpc, []int{13} }
...
func init() {
	...
	proto.RegisterType((*GetBlockRequest)(nil), "wavelet.GetBlockRequest")
	proto.RegisterType((*GetBlockResponse)(nil), "wavelet.GetBlockResponse")
}
...
func (c *waveletClient) GetBlock(ctx context.Context, in *GetBlockRequest, opts ...grpc.CallOption) (*GetBlockResponse, error) {
	out := new(GetBlockResponse)
	err := grpc.Invoke(ctx, "/wavelet.Wavelet/GetBlock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Wavelet_GetBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WaveletServer).GetBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wavelet.Wavelet/GetBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WaveletServer).GetBlock(ctx, req.(*GetBlockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Wavelet_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBlock",
			Handler:    _Wavelet_GetBlock_Handler,
		},
	},
...
var fileDescriptorRpc = []byte{
	...
	,
}
